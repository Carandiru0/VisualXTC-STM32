#ifndef SDF_X_HEADER_JPEG_H 
#define SDF_X_HEADER_JPEG_H 


namespace SDF_x_Header  
{

static constexpr uint16_t const ORIGWIDTH =		1262;
static constexpr uint16_t const ORIGHEIGHT =	947;
